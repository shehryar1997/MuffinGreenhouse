...
// The official WhatsApp glyph (lucide dropped its brand icons, and a speech bubble doesn't read as WhatsApp).
...
// Rendered inside <FloatingActions>, which owns the fixed position and the spacing between the floating buttons.
