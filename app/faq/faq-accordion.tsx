...
const faqs = [
  ...
  { question: "Why do some products take longer to arrive?", answer: "A few tools and supplies ship from overseas. We order them once your payment is confirmed, so they reach you in about 14 days rather than 1-2 business days. These products are marked \"Ships from overseas\", and checkout shows your estimated delivery date. If you order them together with other items, the whole order ships together once the overseas item arrives." },
