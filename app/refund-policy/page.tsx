    ...
    <div className="min-h-screen bg-cream-100">
      <div className="container mx-auto px-6 lg:px-12 py-16 max-w-4xl">
        <section className="mb-12">
          ...
          <p className="text-forest-950/60 mt-4 text-sm">Last updated: January 2026</p>
        </section>
        <div className="bg-white rounded-sm p-8 border border-forest-950/10">
          ...
          <div className="space-y-6 text-forest-950/80">
            ...
            <h2 className="font-serif text-xl text-forest-950">3. Refund Process</h2>
