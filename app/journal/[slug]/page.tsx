      ...
      <div className="relative h-[60vh] min-h-[500px]">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8">
          <div className="container mx-auto px-4 max-w-3xl">
            <Link href="/journal" className="inline-flex items-center gap-2 text-cream-300 hover:text-white mb-4 transition-colors">
              <ArrowLeft className="w-4 h-4" />
              Back to Journal
            </Link>
            <h1 className="font-serif text-display text-white">{post.title}</h1>
            <div className="flex items-center gap-4 mt-4 text-cream-300">
