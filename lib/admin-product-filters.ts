...
export const PRODUCT_FILTERS = ["out_of_stock", "unpublished", "published"] as const
...
export function matchesProductFilters(
  p: { name: string; sku: string; category_name: string | null; stock_status: string | null; published_at: string | null },
